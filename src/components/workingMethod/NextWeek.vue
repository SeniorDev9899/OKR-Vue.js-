<template>
<div class="bottom-left next-week-task">
    <div class="header d-flex justify-space-between py-3 px-4">
        <span class="left" v-if="!chkSettingDate">未来四周计划</span>
        <span :class="(chkSettingDate) ? 'drange left pt-2':'drange right pt-2'">
            ...
            <date-range-picker ref="picker" opens="center" :locale-data="{ 
                    ...
                    }" :minDate="minDate" :maxDate="maxDate" :dateRange="dateRange2" :ranges="false" @update="dateFilter">
...
export default {
    ...
    data() {
        return {
            dateRange2: {
                startDate: '2021-08-06 00:00:00',
                endDate: '2021-08-12 00:00:00'
            },
            minDate: '2018-01-01',
            maxDate: '2050-12-31',
    ...
    mounted() {
        ...
        this.dateRange2 = this.getCurrentWeek();
        this.filterDate = this.dateRange2;
    },
    computed: {
    ...
    methods: {
        ...
        getCurrentWeek() {
            ...
            let last = first + 27; // last day is the first day + 6
        ...
        restoreFilter(param) {
            ...
            this.dateRange2 = Object.assign({}, this.getCurrentWeek());
            param.clickCancel();
            this.filterDate = this.dateRange2;
        },
        openTaskEdit(prop) {
...
.next-week-task .right .daterangepicker.openscenter {
    left: -40% !important;
}

.next-week-task .left .daterangepicker.openscenter {
    left: 110% !important;
}
</style>
