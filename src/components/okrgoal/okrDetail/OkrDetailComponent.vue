  ...
  <!-- banner -->
    <div class="object-container d-flex justify-space-between align-center mb-4 mt-12">
      ...
      <div style="position: relative;">
          <span style="cursor: pointer;">
            <v-progress-linear :value="selectedObj.ob_progress" color="rgb(159, 191, 255)" height="14" :rounded="true" class="okr-progress-linear" @click="openPercentDialog">
    ...
    <div class="content-container h164" color="white">
      <div class="tab-1" v-if="tabIndex == 0">
        <OKRsComponent :object_id="object_id" />
      </div>
...
export default {
  ...
  methods: {
    ...mapActions('okr', ['getOkrs', 'updateOkr', 'getDetail', 'getOkrsForAddsort']),
